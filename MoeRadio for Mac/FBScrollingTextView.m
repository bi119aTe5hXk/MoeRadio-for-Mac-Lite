...
//#define kFBScrollingTextViewSpacing 0.4

#define kFBScrollingTextViewDefaultScrollingSpeed 1
#define kFBScrollingTextViewStartScrollingDelay 0.5
...
- (void)setString:(NSString *)_string {
	...
	if ([self stringWidth] > thisFrame.size.width) {
        ...
        cursor = NSMakePoint(thisFrame.size.width/2-[self stringWidth]/2, 0);
        textviewSpacing = 0;
    }
	[self setNeedsDisplay:YES];
...
- (void)drawRect:(CGRect)rect {
	...
	CGFloat spacing = round(rWidth * textviewSpacing);
